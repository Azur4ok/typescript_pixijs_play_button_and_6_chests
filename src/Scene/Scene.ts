...
export abstract class AbstractGameScene implements GameScene {
    ...
    constructor(app: Application) {
        ...
        this.fadeInSceneTransition = new SimpleFadeTransition(app, TransitionType.FADE_IN, .1);
        this.fadeOutSceneTransition = new SimpleFadeTransition(app, TransitionType.FADE_OUT, .1);
    }
